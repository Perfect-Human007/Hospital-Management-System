...
class SslCommerzPaymentController extends Controller
{
    ...
    {
        $doctor = doctor::all();
        return view('exampleHosted',compact('doctor'));
    }
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_add1'] = isset($_POST['address']) ? $_POST['address'] : "93 B, New Eskaton Road";
        $post_data['doc'] = isset($_POST['doctor']) ? $_POST['doctor'] : "doctor A";
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data['cus_email'] = isset($_POST['customer_email']) ? $_POST['customer_email'] : "john.doe@email.com";
        $post_data['cus_add1'] =  isset($_POST['address']) ? $_POST['address'] : "93 B, New Eskaton Road";
        $post_data['doc'] =  isset($_POST['address']) ? $_POST['address'] : "93 B, New Eskaton Road";
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = "";
