      ...
      @if(Route::has('login'))
       ...
       @else
            <div class="page-section" id="appointment">
              <div class="container">
                <h1 class="text-center wow fadeInUp">To Make an Appointment</h1>
                 <h3 class="text-center wow fadeInUp">You Need to login First</h3>
                 <br>
                  <div align="center">
                     <a class="btn btn-primary ml-lg-3" href="{{route('login')}}">Login </a>
                     </div>
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">onehealth@temporary.net</a>
